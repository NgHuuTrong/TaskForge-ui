...
const backgroundImage = [
  ...
  },
  {
    key: 2,
    backgroundPath:
      'https://images.unsplash.com/photo-1696595883516-76c97aa3a164?auto=format&fit=crop&q=80&w=1770&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    key: 3,
    backgroundPath:
      'https://images.unsplash.com/photo-1697201826242-141dec817a6f?auto=format&fit=crop&q=80&w=1935&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    key: 4,
    backgroundPath:
      'https://images.unsplash.com/photo-1697577473134-46490cf51044?auto=format&fit=crop&q=80&w=1770&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    key: 5,
    backgroundPath:
      'https://images.unsplash.com/photo-1696837412004-cb6580ab1cc3?auto=format&fit=crop&q=80&w=1887&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
  {
    key: 6,
    backgroundPath:
      'https://images.unsplash.com/photo-1697701859524-f4cc65e4747a?auto=format&fit=crop&q=80&w=1770&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
  },
];
...
function CreateBoard() {
  ...
  const PopoverHeader = (
    <div className="flex flex-row justify-center items-center">
      <span className="text-[--color-grey-500] text-[14px] font-semibold mx-[10px]">Board background</span>
    </div>
  );

  const renderBackgroundImageList = () => {
    return backgroundImage.map(
      (item) =>
        item.key < 5 && (
          <div
            onClick={() => {
  ...
  const renderBackgroundColorList = () => {
    return backgroundColor.map((item) =>
      item.key < 6 ? (
        <div
          onClick={() => {
            setSelectedIndex(item.key);
  ...
  return (
    <div className="p-[12px]">
      ...
      <div className="flex flex-col gap-[8px] mt-[16px]">
        <span className="text-[12px] font-bold leading-[16px] text-[--color-grey-500]">Background</span>
        <div className="flex flex-row justify-between">{renderBackgroundImageList()}</div>
        <div className="flex flex-row justify-between">{renderBackgroundColorList()}</div>
      </div>

      <div className="mt-[16px]">
        <span className="text-[12px] font-bold leading-[16px] text-[--color-grey-500]">Board title</span>
        ...
        <div className="flex flex-row items-center gap-[10px] py-[5px]">
          ...
          <p className="text-[14px] text-[--color-grey-500]">Board title is required</p>
        </div>
      </div>
    </div>
  );
...
function PopoverContent({ selectedIndex, setSelectedIndex, backgroundType, setBackgroundType }) {
  const renderPopoverBackgroundImageList = () => {
    return backgroundImage.map((item) => (
      <div
        onClick={() => {
          setSelectedIndex(item.key);
          setBackgroundType('image');
