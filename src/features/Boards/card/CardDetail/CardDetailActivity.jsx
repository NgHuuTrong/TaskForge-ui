        ...
        <div className='w-full'>
            ...
            <div className='grid grid-cols-12 mt-5'>
                <div className="col-span-1">
                    {user && <UserDetail user={user} showDetail={false} />}
                </div>
                <div className="col-span-10">
                    <ReactQuill className="w-full" modules={module} theme="snow" value={contentComment} onChange={setContentComment} />
                    {
                        contentComment && <div className='flex gap-3 mt-3'>
                            ...
                            <Button type='secondary' size='small' disabled={isCreating} onClick={() => setContentComment('')}>Cancel</Button>
                        </div>
                    }
                </div>
            </div>
                ...
                </p>
                {
                    allowEdit ? <>
                        ...
                        <div className='flex space-x-3 mt-3 '>
                            <Button
                                type='primary' size='small' disabled={isQuillEmpty(value) || isDeleting || isUpdating}
                                onClick={() => {
                                    updateComment({ commentId: comment.id, body: { content: value } }, {
                                        onSuccess: () => {
                        ...
                        />
                        {
                            (comment.commenter.id === user.id) && <div className='flex items-center gap-2'>
                                <button
