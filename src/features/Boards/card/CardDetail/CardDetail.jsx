...
function CardDetail({ openCardDetailModal, setOpenCardDetailModal, lists }) {
      ...
      >
        <div className="grid grid-cols-4 gap-5">
          <div className="space-y-8 col-span-3">
            ...
            {card.cardAttachments && card.cardAttachments.length > 0 && (
              <CardDetailAttachments attachments={card.cardAttachments} />
            )}
