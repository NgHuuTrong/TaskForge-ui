...
function BoardCard({ board }) {
  ...
  return (
    ...
    >
      <div className={`w-full aspect-video p-[0.8rem] ${(!board.visibility && !isMember) ? 'bg-black/50' : 'bg-transparent hover:bg-black/20'} relative group/item`}>
        ...
        {
          isMember && <div className="absolute bottom-[1rem] right-[1rem] invisible translate-x-3 group-hover/item:visible group-hover/item:translate-x-0 transition-all duration-300">
