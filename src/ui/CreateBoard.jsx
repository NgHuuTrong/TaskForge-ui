...
function CreateBoard(props) {
  ...
  return (
    <div className='w-[304px] p-[12px] shadow-md border'>

      <div onClick={() => { }} className='flex flex-row justify-between items-center'>
      ...
      <div className='flex gap-[8px] items-center mt-[8px]'>
        <img className="w-[40px] h-[40px] rounded-[4px]" src={props.template.backgroundPath} alt="" />
        <span className='text-[14px] leading-[20px] font-bold'>{props.template.title}</span>
      </div>
