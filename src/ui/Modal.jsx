        ...
        <div className={`${classModalContainer}`}>
          ...
          <div className="flex flex-1 flex-col px-20 py-10">
            <div className="mt-10 flex flex-col">
              <div className="text-4xl font-medium">Let's build a Workspace</div>
              ...
              <div className="my-10">
                ...
                <div className="flex max-w-xl">
                  <input
                    ...
                    className="w-[30rem] rounded-md border-[0.2rem] p-2 text-base outline-none transition-colors duration-500 focus:border-[var(--color-brand-500)]"
                    value={workspaceName}
