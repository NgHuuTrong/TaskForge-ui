...
function Modal({
  ...
  const dialog = openModal && createPortal(
    <dialog
      ref={dialogRef}
        ...
        <div className="flex flex-1 flex-col px-20 py-10">
          ...
          <div className="flex flex-col justify-evenly">
            ...
            <div className="mt-10">
              ...
              <button className={`h-16 w-[30rem] text-xl transition-colors duration-500 ${workspaceName.length > 0 ? ' bg-[--header-button-txt-hovered] text-white' : ' bg-[--color-grey-100] text-[--color-grey-400] cursor-not-allowed'}`}>
                Continue
              </button>
            </div>
          </div>
